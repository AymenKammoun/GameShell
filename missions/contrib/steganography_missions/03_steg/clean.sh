...
rm -f "$GSH_HOME/Castle/Main_building/Throne_room/scene_as28e.jpg"
rm -f "$GSH_HOME/Castle/Main_building/Throne_room/scene_926a2.jpg"
rm -f "$GSH_HOME/Castle/Main_building/Throne_room/scene_1a7b7.jpg"
rm -f "$GSH_HOME/Castle/Main_building/Throne_room/scene_t7g1e.jpg"
rm -f "$GSH_HOME/Castle/Main_building/Throne_room/traitor_name.txt"
rm -f "$GSH_HOME/Castle/Main_building/Throne_room/Safe/cryptic_note.txt"
